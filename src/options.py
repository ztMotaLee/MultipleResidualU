...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--cropx", type=int, default=256, help="image size after cropping")
        self.parser.add_argument("--cropy", type=int, default=256, help="image size after cropping")
        ...
        self.parser.add_argument("--scheduler", type=list, default=[250,450,600,700,800,900], help="learning rete scheduler")
